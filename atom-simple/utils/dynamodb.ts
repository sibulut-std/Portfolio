...
export async function getUserMetadata(id: string, username_str: string): Promise<UserMetadata> {
...
export async function updateUserMetadata(id: string, username_str: string, metadata: Partial<UserMetadata>) {
